...
- [x] Every exact group uses deployed source plus a runtime receiver `tableId` equal to the requested numeric ID; unrelated and unresolved writes never enter `writers`. <!-- 2026-07-26: complete deployed-source report, including runtime RecordRef -->
